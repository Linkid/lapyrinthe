...
class Interface:
    ...
    def licence(self):
        ...
        btn_quit = Button(t_lic, compound=LEFT, image=self.icon_ferm, text=_("Close"), command=t_lic.destroy)
    ...
    def credit(self):
    	...
    	btn_quit = Button(t_cred, compound=LEFT, image=self.icon_ferm, text=_("Close"), command=t_cred.destroy)
